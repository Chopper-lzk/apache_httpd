...
/** Specifies the status of a redis src */
typedef enum
{
 ...
 * @param rs    src to query
 * @param p     Pool to allocate answer from
 * @param baton location to store src INFO response string
 */
...
{
/* # Server */
    /** Major version number of this src */
    apr_uint32_t major;
    /** Minor version number of this src */
    apr_uint32_t minor;
    /** Patch version number of this src */
    apr_uint32_t patch;
...
/* # Memory */
    /** Max memory of this src */
    apr_uint64_t maxmemory;
    /** Amount of used memory */
    apr_uint64_t used_memory;
    /** Total memory available on this src */
